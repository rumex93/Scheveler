...
<script type="text/javascript">
	...
	{
		$.post("reportajaxfinal.action", {articleCode : '${articleCode}', reportReason : $("#reportReason option:selected").val(), reportDetail : $("#reportDetail").val()}, function(data)
		{
			alert(data);
			closeWindow();
		});
...
<div>	
	...
	<div class="report_body">
		<div>
			...
			<span>제&nbsp;&nbsp;&nbsp;목</span> :&nbsp;&nbsp; ${articleTitle }<br><br>
			<span>작성자</span> :&nbsp;&nbsp; ${writerMemberId }<br>
	...
	<div class="report_bottom">
		<button type="submit" class="btn btn-default" id="reportBtn">신고하기</button>
