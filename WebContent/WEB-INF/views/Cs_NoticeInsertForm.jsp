...
<head>
<meta charset="utf-8">
<title>Cs_NoticeInsertForm.jsp</title>
...
<link rel="stylesheet" type="text/css" href="css/cs_noticeinsert.css">
    ...
    <div id="container">
      ...
      <form method="post" action="noticeinsert.action">
		  ...
		  <div class="detail_content">
		  	...
		  	<table class = "input_table">
		  		<tr> 
		  			<th>제목 : </th>
		  			<td>
		  				<input type="text" class="notice_title" id="notice_title" name="notice_title">
		  			</td>
		  		</tr>
		  		<tr>
		  			<th>&nbsp;</th>
		  		...
		  		<tr>
		  			<th>공지사항 유형 : </th>
		  			<td>
		  				<select id="type_selected" name="notice_type_code" class="notice_type_code">
		  					<option value="NT1">[이벤트]</option>
		  					<option value="NT2">[점검]</option>
		  					<option value="NT3">[안내]</option>
		  				</select>
		  				<input type="text" value="${member_code }"style="display:none;">
		  			</td>
		  		</tr>
		  		<tr>
		  			<th>&nbsp;</th>
		  ...
		  <div class="detail_bottom">	
		  	...
		  	<button type="button" class="cancel_btn" id="list_btn">취소</button>
