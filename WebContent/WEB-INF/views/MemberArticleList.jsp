	...
	<div id="container">
		<div class="ct_nav">
			<ul>
				...
				<li class="nav_text"><span><a href="#">${memberId } 님의 게시글</a></span></li>
			</ul>
		</div>
		<div class="ct_title">
			<h1></h1>
		...
		<div class="notice_main">
			<div>
				<span href="#" style="color: black; font-size: 30px;">${memberId } 님이 작성한 게시글</span>
				<hr>
			</div>
			<div class="notice_bottom">
				...
				<div class="notice_content">
					<table>
						...
						<tr>
							<td>${dao.boardTypeDetail }</td>
							<td>${dao.bno }</td>
							<c:choose>
								<c:when test="${pageNum == null }">
								<td><a href="javascript:location.href='memberdetailopen.action?articleCode=${dao.articleCode }&bno=${dao.bno }&pageNum=${pageNum = 1 }&memberId=${memberId }'"  style="color: black;">${dao.articleTitle }</a></td>
								</c:when>
								<c:when test="${pageNum != null }">
								<td><a href="javascript:location.href='memberdetailopen.action?articleCode=${dao.articleCode }&bno=${dao.bno }&pageNum=${pageNum }&memberId=${memberId }'"  style="color: black;">${dao.articleTitle }</a></td>
								</c:when>
							</c:choose>
							<td>${dao.memberId }</td>
