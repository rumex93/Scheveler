...
<link rel="stylesheet" type="text/css" href="css/SignIn_TOSAgree.css">
...
<script type="text/javascript">
	...
	$(document).ready(function () 
	{
      	...
      	//회원가입 버튼 클릭시 동의 체크여부 팝업창
      	$("#si_submit").click(function () 
      	{
        	//alert("확인");
        	var chk = $("#check1").is(":checked");
        	var chk2 = $("#check2").is(":checked");
        	var chk3 = $("#check3").is(":checked");
        	...
        	{
          		alert("이용약관 이용 동의해주세요");
          		$("#check2").focus();
          		return false;
        	}
        	else if (!chk3) 
        	{
          		alert("마케팅 홍보 및 이용 동의해주세요");
          		$("#check3").focus();
          		return false;
        	}
...
<div id="wrap">
    ...
    <div id="header">
        ...
        <div class="top-width">
      	...
      	<nav class="sub_navbar">
        	<!-- logo -->
        	<div class="logo"> <a href="mainopen.action"> <b>스케블러</b> &nbsp;&nbsp; 완벽한 여행을 위한 계획</a> </div><!-- end .logo -->
    ...
    <div id="content" class="content">
      	<form action="joinopen.action" name="agree_Form" method="">
        	<div class="body_form">
          		<h2 class="body_title">회원가입</h2>
          		<h3 class="body_sub">약관 동의</h3>
          		<hr>
          		<table class="body_table">
            		<tr>
              			<td>
                			<p align="center">
                  				회원으로 가입하기 위해서는 이용약관, 개인정보처리방침에 동의하셔야 합니다.
                			</p>
              			</td>
            		</tr>
            		<tr>&nbsp;</tr>
            		<tr>
              			<td align="left">
                			<p align="left">
                  			<span style="padding-top: 30px">■개인정보 이용 동의</span>
                  			<br>
                			</p>
                			<textarea rows="10" cols="100" align="center">
가. 개인정보의 수집 및 이용 목적
① 스케블러은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 개인정보 보호법 제18조에 따라 별도의 동의를 받는 등 필요한 조치를 이행할 예정입니다.
1. 스케블러 서비스 제공을 위한 회원관리
1) 공간정보 다운로드, 오픈API 신청 및 활용 등 포털 서비스 제공과 서비스 부정이용 방지를 목적으로 개인정보를
   처리합니다.

나. 수집하는 개인정보의 항목
① 국가공간정보포털 회원정보(필수): 이름, 이메일(아이디), 비밀번호, 휴대폰번호
...
위 개인정보의 수집 및 이용에 대한 동의를 거부할 수 있으나, 동의를 거부할 경우 회원 가입이 제한됩니다.</textarea>
            		...
            		<tr>
              			<td>
                			<input type="checkbox" class="box1" id="check1"><label for="check1"> 개인정보 수집 및 이용에 동의합니다.(필수)</label>
              			</td>
            		</tr>
            		<tr>
              			<td align="left">
                			<p align="left">
                  			<span style="padding-top: 30px">■이용약관 이용 동의</span>
                  			<br>
                			</p>
                			<br>
                			<textarea rows="10" cols="100" align="center">
...
본 약관은 스케블러 웹사이트(이하 "스케블러")가 제공하는 모든 서비스(이하 "서비스")의 이용조건 및 절차, 회원과 국가공간정보포털의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.
...
1. 스케블러은 회원의 개인 신상 정보를 본인의 승낙없이 타인에게 누설, 배포하지 않습니다. 단, 전기통신관련법령 등 관계법령에 의하여 관계 국가기관 등의 요구가 있는 경우에는 그러하지 아니합니다.
2. 스케블러은 법령과 본 약관이 금지하거나 미풍양속에 반하는 행위를 하지 않으며, 지속적·안정적으로 서비스를 제공하기 위해 노력 할 의무가 있습니다.
3. 스케블러은 이용자의 귀책사유로 인한 서비스 이용 장애에 대하여 책임을 지지 않습니다.
...
1. 스케블러은 서비스 이용과 관련하여 이용자에게 발생한 손해에 대하여 국가공간정보포털의 중대한 과실, 고의 또는 범죄행위로 인해 발생한 손해를 제외하고 이에 대하여 책임을 부담하지 않으며, 이용자가 본 서비스에 게재한 정보, 자료, 사실의 신뢰도, 정확성 등 내용에 관하여는 책임을 지지 않습니다.
2. 스케블러은 서비스 이용과 관련하여 이용자에게 발생한 손해 중 이용자의 고의, 실수에 의한 손해에 대하여 책임을 부담하지 아니합니다.
3. 스케블러은 이용자간 또는 이용자와 제3자간에 서비스를 매개로 하여 물품거래 혹은 금전적 거래 등과 관련하여 어떠한 책임도 부담하지 아니하고, 이용자가 서비스의 이용과 관련하여 기대하는 이익에 관하여 책임을 부담하지 않습니다.

제 16 조 (재판관할)

스케블러과 이용자간에 발생한 서비스 이용에 관한 분쟁에 대하여는 대한민국 법을 적용하며, 본 분쟁으로 인한 소는 민사소송법상의 관할법원에 제기합니다.
부 칙 1. (시행일) 본 약관은 2016년 1월 1일부터 시행됩니다.</textarea>
              			</td>
            		</tr>
            		<tr>
              			<td>
                			<input type="checkbox" class="box2" id="check2"><label for="check2">위의 이용약관에 동의합니다.(필수)</label>
              			</td>
            		</tr>
            		<tr>
              			<td align="left">
                			<p align="left">
                  			<span style="padding-top: 30px">■마케팅 홍보 및 이용 동의</span>
                  			<br>
                			</p>
			                <textarea rows="5" cols="100" align="center">
[마케팅 정보 제공 및 설문조사를 위한 개인정보의 수집, 이용 동의서] 
스케블러에서는 고객의 개인정보를 중요시 하며, 「개인정보보호법」 제15조, 제17조, 제22조 및 제24조에 따라 동의를 얻고자 합니다. 동의여부 및 개인정보를 적어 보내주시기 바랍니다. 항목:이메일 , 수집목적:마케팅 및 SNS 홍보자료, 보유 : X</textarea>
	              		</td>
            		</tr>
            		<tr>
              			<td>
                			<input type="checkbox" class="box3" id="check3"><label for="check3">위의 이용약관에 동의합니다.(필수)</label>
              			</td>
            		</tr>
            		<tr>
              			<td>
                			<input type="checkbox" class="box4" id="check4">
                			<label for="check4">회원으로 가입하기 위해서는 이용약관, 개인정보처리방침, 마케팅 및 홍보 개인정보 수집에 동의 모두
                			동의합니다.</label>
              			</td>
            		</tr>
          		</table>
          		<button type="submit" class="si_btn" id="si_submit">회원가입</button>
          		<button type="reset" class="si_btn" id="si_reset">취소</button>
        	</div>
      	</form>
  	</div>
  	<!-- end content -->
