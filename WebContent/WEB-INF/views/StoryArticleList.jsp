	...
	<div id="container">
		...
		<div class="notice_main">
			...
			<div class="notice_list">
				<ul>
					<li class="selected"><a href="storyopen.action">여행 자랑 게시판</a></li>
					<li><a href="tiparticleopen.action"><span style="color: #4f79d0; font-size: 18px; font-weight: bold;">여행 팁 게시판</span></a></li>
			...
			<div class="notice_bottom">
				...
				<div class="notice_search">
					<form action="storysearchopen.action">
						...
						<button id="searchBtn"><div class="xi-search xi-x"></div></button>
					</form>
				</div><br>
				<div class="notice_content">
					<table>
						...
						<tr>
							...
							<c:choose>
								...
								<td><a href="javascript:location.href='storydetailopen.action?articleCode=${dao.articleCode }&bno=${dao.bno }&pageNum=${pageNum = 1 }'"  style="color: black;">${dao.articleTitle }</a></td>
								</c:when>
								<c:when test="${pageNum != null }">
								<td><a href="javascript:location.href='storydetailopen.action?articleCode=${dao.articleCode }&bno=${dao.bno }&pageNum=${pageNum }'"  style="color: black;">${dao.articleTitle }</a></td>
								</c:when>
							</c:choose>
							<td>${dao.memberId }</td>
					...
					<div class="table_bottom">
						...
						<a href="storyarticlewriteform.action">
