...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			{
				if (confirm("선택한 쪽지들을 휴지통에 버리시겠습니까?"))
				{
					$('#deleteForm').submit();
				}
			});
	...
	<div id="wrap">
		<div id="header">
			<nav class="sub_navbar">
				...
				<div class="right-menu">
					<form action="notereceivesearch.action">
		...
		<div id="container">
			...
			<div class="ct_left_menu">
				...
				<ul>
					<li>
						<dl>
							<dd>
								<a href="mymessagereceive.action" style="font-weight: bold;">- 받은 쪽지함</a>
							</dd>
							<dd>
			...
			<div id="msgList">
				...
				<!-- realMsgList -->
				<div id="realMsgList">
				<form action="notemultiplebin.action" id="deleteForm" method="post">
					<table class='table'>
						<!-- jsp로 유동적 출력 -->
						<tr>
							<th></th>
