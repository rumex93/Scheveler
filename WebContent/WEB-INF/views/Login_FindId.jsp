...
<script type="text/javascript">
    ...
    $(document).ready(function () {
      ...
      $('#login_submit').click(function()
	  {
    	    ...
    	    else if(!isValidName(f.login_name.value))
    	    {
    	    ...
    	    else if(!isValidEmail(f.login_email.value))
    	    {
  ...
  <div id="wrap">
    ...
    <div id="content">
      <div class="login-form">
        <form action="login_findidresult.action" method="post" name="myForm">
        	<h1>아이디 찾기</h1>
          <input type="text" name="login_name" id="login_name" class="text-field" placeholder="이름">
          <input type="text" name="login_email" id="login_email" class="text-field2" placeholder="이메일">
          <input type="submit" value="찾기" class="submit-btn" id="login_submit">
          <input type="button" value="취소" class="submit-btn" onclick="javascript:location.href='main.action'">
        </form>
      </div>
    </div>
    <!-- end content -->
