...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			...
			{
				if (confirm("삭제 시 복원 불가능 합니다.\n삭제하시겠습니까?"))
				{
					$('#noteForm').attr("action", "notebindelete.action");
					$('#noteForm').submit();
				}
			...
			{
				if (confirm("쪽지를 복원하시겠습니까?"))
				{
					$('#noteForm').attr("action", "notebinrecover.action");
					$('#noteForm').submit();
				}
		...
		<div id="header">
			<nav class="sub_navbar">
				...
				<div class="right-menu">
					<form action="notebinsearch.action">
				...
				<ul>
					<li>
						<dl>
							...
							<dd>
								<a href="mymessagebin.action" style="font-weight: bold;">- 휴지통</a>
							</dd>
						</dl>
					</li>
				</ul>
			...
			<div id="msgList">
				...
				<div class="list_top">
					...
					<div class="delCheck-btns">
						...
						<button id="recoverBtn">복원</button>
