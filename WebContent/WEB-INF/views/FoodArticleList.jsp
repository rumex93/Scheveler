		...
		<div class="notice_main">
			...
			<div class="notice_list">
				<ul>
					...
					<li class="selected"><a href="foodarticleopen.action">맛집 게시판</a></li>
				</ul>
			</div>
			<div class="notice_bottom">
				...
				<div class="notice_search">
					<form action="foodsearchopen.action">
				...
				<div class="notice_content">
					<table>
						...
						<tr>
							...
							<c:choose>
								...
								<td><a href="javascript:location.href='fooddetailopen.action?articleCode=${dao.articleCode }&bno=${dao.bno}&pageNum=${pageNum = 1}'"
								style="color: black;">${dao.articleTitle }</a></td>
								</c:when>
								<c:when test="${pageNum != null }">
								<td><a href="javascript:location.href='fooddetailopen.action?articleCode=${dao.articleCode }&bno=${dao.bno}&pageNum=${pageNum }'"
								style="color: black;">${dao.articleTitle }</a></td>
								</c:when>
							</c:choose>
							<td>${dao.memberId }</td>
					...
					<div class="table_bottom">
						...
						<a href="foodarticlewriteform.action">
