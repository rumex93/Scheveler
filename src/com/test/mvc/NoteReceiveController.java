...
public class NoteReceiveController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			...
			int dataCount = dao.getDataCountReceive(membercode);
			...
			lists = dao.receiveMsgList(membercode,start,end);
			mav.addObject("lists", lists);
			
			
			String listUrl = "mymessagereceive.action";
