/*====================================
   StoryCommentDeleteController.java
====================================*/
...
public class StoryCommentDeleteController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		// 이전 페이지(StoryArticleDetail.jsp)로 부터 댓글 삭제 관련 데이터 수신
		...
		try
		{
			...
			mav.setViewName("redirect:storydetailopen.action?pageNum=" + pageNum
