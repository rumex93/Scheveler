...
public class NoteBinController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			...
			int dataCount = dao.getDataCountBin(membercode);
			...
			lists = dao.binMsgList(membercode,start,end);
			mav.addObject("lists", lists);
			
			
			String listUrl = "mymessagebin.action";
