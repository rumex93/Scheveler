...
public class MemberArticleController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		int dataCount = cdao.getMemberDataCount(memberId);
		...
		try
		{
			lists = cdao.memberArticleLists(start, end, memberId);
			
			mav.addObject("lists", lists);
			
			
			String listUrl = "memberarticlelist.action?memberId=" + memberId;
			String pageIndexList = pdao.getIndexList(currentPage, totalPage, listUrl);
			
			mav.addObject("pageIndexList", pageIndexList);
			
			mav.setViewName("MemberArticleList");
