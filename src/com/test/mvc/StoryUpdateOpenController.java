/*=================================
   StoryUpdateOpenController.java
==================================*/
...
public class StoryUpdateOpenController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		// 이전 페이지(StoryArticleDetail.jsp) 로 부터 데이터 수신
		...
		try
		{
			...
			mav.setViewName("StoryArticleUpdateForm");
