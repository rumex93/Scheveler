...
public class NoteBinSearchController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			...
			int dataCount = dao.getDataCountBinSearch(searchType, searchValue, membercode);
			...
			lists = dao.noteSearchBin(searchType, searchValue, membercode, start, end);
			mav.addObject("lists", lists);
			
			
			String listUrl = "notebinsearch.action?searchType=" + searchType + "&searchValue=" + searchValue;
			String pageIndexList = paging.getIndexList(currentPage, totalPage, listUrl);
			
			mav.addObject("pageIndexList", pageIndexList);
			
			mav.setViewName("My_MessageBin");
		} catch (Exception e)
		{
