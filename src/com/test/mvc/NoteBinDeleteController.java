...
public class NoteBinDeleteController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			if (noteCodes != null)
			{
				...
				{
					// note_real_receiver_delete 를 sysdate로 업데이트 메소드
					nDao.realDeleteFromBin(noteCode);
