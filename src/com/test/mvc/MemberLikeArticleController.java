...
public class MemberLikeArticleController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		int dataCount = cdao.getMemberLikeDataCount(memberId);
		...
		try
		{
			lists = cdao.memberLikeLists(start, end, memberId);
			
			mav.addObject("lists", lists);
			
			
			String listUrl = "memberlikearticlelist.action?memberId=" + memberId;
			String pageIndexList = pdao.getIndexList(currentPage, totalPage, listUrl);
			
			mav.addObject("pageIndexList", pageIndexList);
			
			mav.setViewName("MemberLikeArticleList");
