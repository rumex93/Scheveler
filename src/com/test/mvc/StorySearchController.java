...
public class StorySearchController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		// 이전 페이지(StoryArticleDetail.jsp)로 부터 searchKey, searchValue 데이터 수신
		...
		try
		{
			...
			String listUrl = "storyopen.action" + param;
