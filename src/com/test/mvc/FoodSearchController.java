...
public class FoodSearchController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		// 이전 페이지(FoodArticleDetail.jsp)로 부터 searchKey, searchValue 데이터 수신
