/*====================================
  FoodCommentUpdateController.java
====================================*/
...
public class FoodCommentUpdateController implements Controller
{
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		try
		{
			...
			mav.setViewName("redirect:fooddetailopen.action?articleCode=" + articleCode
